...
from gggg_p2_mm_apellido1_apellido2 import Solution1 # import your StudentHeuristic here
...
my_player = Player(
    ...
    strategy=MinimaxStrategy( #MinimaxAlphaBetaStrategy(
        heuristic=Heuristic(name=my_heuristic.get_name(), evaluation_function=my_heuristic.evaluation_function),
        max_depth_minimax=3,
        verbose=0
    )
)
